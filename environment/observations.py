...
def _obsfunc_5(env):
    """Observe [pose, velocities, cable_forces, intergrated_error]"""
    return np.vstack(env.pose, 
                     env.pose_dot, 
                     env.f,
                     env.I).ravel()  
_obsvars_5 = [states.pose, states.spatial_velocity, states.cable_forces, states.intergrated_error]
obsfunc5 = ObservationFunction(_obsfunc_5, _obsvars_5)
